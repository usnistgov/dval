...
class TestAccuracyLabels(unittest.TestCase):
    ...
    def testBest(self):
        ...
        self.assertEqual(1.0, METRICS_DICT['accuracy'](GROUND_TRUTH_LABEL, PREDICTED_BEST_LABEL))

    def testOk(self):
        self.assertEqual(0.5, accuracy(GROUND_TRUTH_LABEL, PREDICTED_OK_LABEL))
        self.assertEqual(0.5, METRICS_DICT['accuracy'](GROUND_TRUTH_LABEL, PREDICTED_OK_LABEL))

    def testBad(self):
        self.assertEqual(0.0, accuracy(GROUND_TRUTH_LABEL, PREDICTED_BAD_LABEL))
        self.assertEqual(0.0, METRICS_DICT['accuracy'](GROUND_TRUTH_LABEL, PREDICTED_BAD_LABEL))
...
class TestF1Indicator(unittest.TestCase):
    ...
    def testBestLabel0(self):
        ...
        self.assertEqual(1.0, METRICS_DICT['f1'](GROUND_TRUTH, PREDICTED_BEST, pos_label=0))
    ...
    def testBadLabel0(self):
        ...
        self.assertEqual(0.0, METRICS_DICT['f1'](GROUND_TRUTH, PREDICTED_BAD, pos_label=0))


class TestF1Labels(unittest.TestCase):

    def testBestLabelb(self):
        self.assertEqual(1.0, f1(GROUND_TRUTH_LABEL, PREDICTED_BEST_LABEL, pos_label='b'))
        self.assertEqual(1.0, METRICS_DICT['f1'](GROUND_TRUTH_LABEL, PREDICTED_BEST_LABEL, pos_label='b'))

    def testBestLabela(self):
        self.assertEqual(1.0, f1(GROUND_TRUTH_LABEL, PREDICTED_BEST_LABEL, pos_label='a'))
        self.assertEqual(1.0, METRICS_DICT['f1'](GROUND_TRUTH_LABEL, PREDICTED_BEST_LABEL, pos_label='a'))

    def testOkLabelb(self):
        self.assertEqual(0.40000000000000008, f1(GROUND_TRUTH_LABEL, PREDICTED_OK_LABEL, pos_label='b'))
        self.assertEqual(0.40000000000000008, METRICS_DICT['f1'](GROUND_TRUTH_LABEL, PREDICTED_OK_LABEL, pos_label='b'))

    def testOkLabela(self):
        self.assertEqual(0.5714285714285714, f1(GROUND_TRUTH_LABEL, PREDICTED_OK_LABEL, pos_label='a'))
        self.assertEqual(0.5714285714285714, METRICS_DICT['f1'](GROUND_TRUTH_LABEL, PREDICTED_OK_LABEL, pos_label='a'))

    def testBadLabelb(self):
        self.assertEqual(0.0, f1(GROUND_TRUTH_LABEL, PREDICTED_BAD_LABEL, pos_label='b'))
        self.assertEqual(0.0, METRICS_DICT['f1'](GROUND_TRUTH_LABEL, PREDICTED_BAD_LABEL, pos_label='b'))

    def testBadLabela(self):
        self.assertEqual(0.0, f1(GROUND_TRUTH_LABEL, PREDICTED_BAD_LABEL, pos_label='a'))
        self.assertEqual(0.0, METRICS_DICT['f1'](GROUND_TRUTH_LABEL, PREDICTED_BAD_LABEL, pos_label='a'))
...
class TestROCAUCIndicator(unittest.TestCase):
    ...
    def testOk(self):
        ...
        self.assertAlmostEqual(0.48571428571428565, METRICS_DICT['rocAuc'](GROUND_TRUTH, PREDICTED_OK))
...
class TestROCAUCLabels(unittest.TestCase):
    ...
    def testBestLabela(self):
        self.assertEqual(1.0, roc_auc(GROUND_TRUTH_LABEL, PREDICTED_BEST_LABEL, pos_label='a'))
        self.assertEqual(1.0, METRICS_DICT['rocAuc'](GROUND_TRUTH_LABEL, PREDICTED_BEST_LABEL, pos_label='a'))

    def testOkLabela(self):
        self.assertAlmostEqual(0.48571428571428565, roc_auc(GROUND_TRUTH_LABEL, PREDICTED_OK_LABEL, pos_label='a'))
        self.assertAlmostEqual(0.48571428571428565,
                               METRICS_DICT['rocAuc'](GROUND_TRUTH_LABEL, PREDICTED_OK_LABEL, pos_label='a'))

    def testOkLabelb(self):
        self.assertAlmostEqual(0.48571428571428565, roc_auc(GROUND_TRUTH_LABEL, PREDICTED_OK_LABEL, pos_label='b'))
        self.assertAlmostEqual(0.48571428571428565,
                               METRICS_DICT['rocAuc'](GROUND_TRUTH_LABEL, PREDICTED_OK_LABEL, pos_label='b'))
