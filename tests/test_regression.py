...
class TestL2(unittest.TestCase):
    ...
    def testBest(self):
        ...
        self.assertEqual(
            0.0, METRICS_DICT["rootMeanSquaredError"](GROUND_TRUTH, PREDICTED_BEST)
        )
    ...
    def testOk(self):
        ...
        self.assertAlmostEqual(
            0.79214897588774291,
            METRICS_DICT["rootMeanSquaredError"](GROUND_TRUTH, PREDICTED_OK),
        )
    ...
    def testBad(self):
        ...
        self.assertAlmostEqual(
            22983.210903885905,
            METRICS_DICT["rootMeanSquaredError"](GROUND_TRUTH, PREDICTED_BAD),
        )
...
class TestAvgL2(unittest.TestCase):
    ...
    def test(self):
        ...
        self.assertAlmostEqual(
            total_score, METRICS_DICT["rootMeanSquaredErrorAvg"](gt, pred)
        )
...
class TestL1(unittest.TestCase):
    ...
    def testBest(self):
        ...
        self.assertEqual(
            0.0, METRICS_DICT["meanAbsoluteError"](GROUND_TRUTH, PREDICTED_BEST)
        )
    ...
    def testOk(self):
        ...
        self.assertAlmostEqual(
            0.67499999999999993,
            METRICS_DICT["meanAbsoluteError"](GROUND_TRUTH, PREDICTED_OK),
        )
    ...
    def testBad(self):
        ...
        self.assertAlmostEqual(
            12789.475, METRICS_DICT["meanAbsoluteError"](GROUND_TRUTH, PREDICTED_BAD)
        )
...
class TestR2(unittest.TestCase):
    ...
    def testOk(self):
        ...
        self.assertAlmostEqual(
            0.88542736505762865, METRICS_DICT["rSquared"](GROUND_TRUTH, PREDICTED_OK)
        )
    ...
    def testBad(self):
        ...
        self.assertAlmostEqual(
            -96446966.194339842, METRICS_DICT["rSquared"](GROUND_TRUTH, PREDICTED_BAD)
        )
