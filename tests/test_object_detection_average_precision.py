...
class TestObjDetAvgP(unittest.TestCase):
    ...
    def testBest(self):
        ...
        np.testing.assert_array_almost_equal(recall_array, computed_recall , decimal=3, err_msg='Recalls don\'t match')
        np.testing.assert_array_almost_equal(precision_array, computed_recall , decimal=3, err_msg='Precisions don\'t match')
        np.testing.assert_array_almost_equal(recall_array, computed_recall , decimal=3, err_msg='AVG precisions don\'t match')
    ...
    def testBad(self):
        recall_array = np.array([0., 0., 0., 0.])
        precision_array = np.array([0., 0., 0., 0.])
        average_precision = 0.
