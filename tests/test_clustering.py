...
from dval.metrics import norm_mut_info, METRICS_DICT
...
class TestNormMutInfo(unittest.TestCase):
    ...
    def testBest(self):
        ...
        self.assertEqual(
            1.0,
            METRICS_DICT["normalizedMutualInformation"](GROUND_TRUTH, PREDICTED_BEST),
        )
    ...
    def testOk(self):
        ...
        self.assertEqual(
            0.48487648752570484,
            METRICS_DICT["normalizedMutualInformation"](GROUND_TRUTH, PREDICTED_OK),
        )
    ...
    def testBad(self):
        ...
        self.assertEqual(
            1.0,
            METRICS_DICT["normalizedMutualInformation"](GROUND_TRUTH, PREDICTED_BAD),
        )
